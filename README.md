...
- This project has absolutely none unit tests, which I consider to be something too risky for any project. I didn't implement it due to the small scope of the project and the fact that it is not a real thing.